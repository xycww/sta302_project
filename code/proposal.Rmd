...
hist(nhanes_data$Poverty, main="figure3: Poverty Index Distribution", xlab="Poverty Index", col="lightgreen")
hist(nhanes_data$PhysActiveDays, main="figure4: Physical Activity Days Distribution", xlab="Phys Active Days", col="lightcoral")
hist(nhanes_data$Age, main="figure5: Age Distribution", xlab="Age", col="lightyellow")
hist(nhanes_data$SleepHrsNight, main="figure6: Sleep Hours Distribution", xlab="Sleep Hours", col="lightpink")
hist(as.numeric(nhanes_data$Gender), main="figure7: Gender Distribution", xlab="Gender (0=Female, 1=Male)", col="lightgray")
